...
cmd_ch1_intp=interp1(Experiment2.RCData.t,Experiment2.RCData.roll,Experiment2.Vicon.t,'spline');
cmd_ch2_intp=interp1(Experiment2.RCData.t,Experiment2.RCData.pitch,Experiment2.Vicon.t,'spline');
...
Experiment2.u1 = Experiment2.u1(Experiment2.t>32 & ...
    Experiment2.t < Experiment2.t(end)-49);
Experiment2.y1 = Experiment2.y1(Experiment2.t>32 &...
    Experiment2.t < Experiment2.t(end)-49);
...
legend('input_{cmd dz}','output_{vicon dz}');
xlabel('Samples');
ylabel('m/s');
grid on;
