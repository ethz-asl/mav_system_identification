...
bagfile_exp1 =  '2016-11-10-14-47-30.bag';
bagfile_exp2 =  '2016-11-10-14-49-11.bag';

topic_imu = '/hawk/fcu/imu';
topic_motor_speed = '/hawk/fcu/motor_speed';
topic_rcdata = '/hawk/fcu/rcdata';
topic_vicon = '/hawk/vrpn_client/estimated_transform';
topic_rpy_thrust_cmd = '/hawk/fcu/command/roll_pitch_yawrate_thrust';
...
Experiment1.rpy_cmd = readCommnadRollPitchYawRateThrust(bag1, topic_rpy_thrust_cmd);
Experiment2.rpy_cmd = readCommnadRollPitchYawRateThrust(bag2, topic_rpy_thrust_cmd);
...
Experiment1.rpy_cmd.t = Experiment1.rpy_cmd.t - Experiment1.rpy_cmd.t(1);
...
Experiment2.rpy_cmd.t = Experiment2.rpy_cmd.t - Experiment2.rpy_cmd.t(1);
...
plot(Experiment1.IMU.t, Experiment1.rpy_imu(1,:)*180/pi, ...
    Experiment1.rpy_cmd.t, Experiment1.rpy_cmd.roll*180/pi, ...
    'g--', 'linewidth', 2);
...
plot(Experiment1.IMU.t, Experiment1.rpy_imu(2,:)*180/pi, ...
    Experiment1.rpy_cmd.t, Experiment1.rpy_cmd.pitch*180/pi, ...
    'g--', 'linewidth', 2);
...
plot(Experiment2.IMU.t, Experiment2.rpy_imu(1,:)*180/pi, ...
    Experiment2.rpy_cmd.t, Experiment2.rpy_cmd.roll*180/pi,...
    'g--', 'linewidth', 2);
...
plot(Experiment2.IMU.t, Experiment2.rpy_imu(2,:)*180/pi, ...
    Experiment2.rpy_cmd.t, Experiment2.rpy_cmd.pitch*180/pi, ...
    'g--', 'linewidth', 2);
...
if length(Experiment1.IMU.t) > length(Experiment1.rpy_cmd.t)
    Experiment1.t = Experiment1.IMU.t;
else
    Experiment1.t = Experiment1.rpy_cmd.t;
end

Experiment1.u1 = interp1(Experiment1.rpy_cmd.t, Experiment1.rpy_cmd.roll, Experiment1.t);
Experiment1.y1 = interp1(Experiment1.IMU.t, Experiment1.rpy_imu(1,:), Experiment1.t);

Experiment1.Ts = mean(diff(Experiment1.t));



if length(Experiment2.IMU.t) > length(Experiment2.rpy_cmd.t)
    Experiment2.t = Experiment2.IMU.t;
else
    Experiment2.t = Experiment2.rpy_cmd.t;
end

Experiment2.u1 = interp1(Experiment2.rpy_cmd.t, Experiment2.rpy_cmd.roll, Experiment2.t);
Experiment2.y1 = interp1(Experiment2.IMU.t, Experiment2.rpy_imu(1,:), Experiment2.t);
...
Experiment1.u2 = interp1(Experiment1.rpy_cmd.t, Experiment1.rpy_cmd.pitch, Experiment1.t);
Experiment1.y2 = interp1(Experiment1.IMU.t, Experiment1.rpy_imu(2,:), Experiment1.t);

Experiment2.u2 = interp1(Experiment2.rpy_cmd.t, Experiment2.rpy_cmd.pitch, Experiment2.t);
Experiment2.y2 = interp1(Experiment2.IMU.t, Experiment2.rpy_imu(2,:), Experiment2.t);
